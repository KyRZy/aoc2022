...
prod = math.prod(monkey.divisible_by for monkey in monkeys)
    ...
    for monkey in monkeys:
        ...
        for item in monkey.items:
            ...
            if worry_level % monkey.divisible_by == 0:
                monkeys[monkey.throw_to_if_true].items.append(worry_level % prod)
            else:
                monkeys[monkey.throw_to_if_false].items.append(worry_level % prod)
        monkey.items = []
